...
public class Main {
    public static void main(String[] args) {
        ...
        colleges.add(new College("yale",6645,62250,77,0.045,-4,0,0.4487,0.7));
        colleges.add(new College("brown",7639,65146,58,0.051,-1,-4,0.5203,0.63));
        colleges.add(new College("harvard",7240,57261,99,0.0341,0,0,0.4192,0.85));
        colleges.add(new College("dartmouth",4458,62658,58,0.0734,-2,-1,0.46,0.67));
        colleges.add(new College("princeton",5604,57410,63,0.0623,-5,-3,0.5715,0.77));
        colleges.add(new College("cornell",15735,57410,56,0.057,-5,-3,0.4771,0.66));
